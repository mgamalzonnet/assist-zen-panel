  ...
  return (
    <div className="p-4 pt-16 sm:pt-6 lg:p-8">
      ...
      <div className="flex items-center justify-between gap-3 mb-6 flex-wrap">
        <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 flex-1 min-w-[200px] max-w-md shadow-sm">
        ...
        <button className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-semibold shadow-sm hover:bg-primary/90 transition-colors flex-shrink-0">
          ...
          <table className="w-full text-sm min-w-[600px]">
            <thead>
              <tr className="border-b border-border bg-secondary/40">
                <th className="py-3.5 px-5 text-right font-semibold text-muted-foreground whitespace-nowrap">اسم الحملة</th>
                <th className="py-3.5 px-5 text-right font-semibold text-muted-foreground whitespace-nowrap hidden sm:table-cell">القناة المرسلة</th>
                <th className="py-3.5 px-5 text-right font-semibold text-muted-foreground whitespace-nowrap">الحالة</th>
                <th className="py-3.5 px-5 text-right font-semibold text-muted-foreground whitespace-nowrap hidden md:table-cell">الإحصائيات</th>
                <th className="py-3.5 px-5 text-right font-semibold text-muted-foreground whitespace-nowrap hidden lg:table-cell">التاريخ</th>
                ...
                return (
                  <tr key={c.id} className="border-b border-border last:border-0 hover:bg-secondary/20 transition-colors">
                    <td className="py-4 px-5 text-right">
                      ...
                      <div className="text-xs text-muted-foreground mt-0.5 truncate max-w-[180px]">{c.preview}</div>
                    </td>
                    ...
                    <td className="py-4 px-5 text-right text-muted-foreground whitespace-nowrap font-mono text-xs hidden lg:table-cell">
                      {c.date}
                    </td>
                    <td className="py-4 px-5">
                      <div className="flex justify-start">
